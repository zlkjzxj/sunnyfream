...
layui.use(['form', 'jquery', "layer"], function () {
    ...
    if (window.sessionStorage.getItem('userFace') && $(".userAvatar").length > 0) {
        ...
        $("#userFace").attr("src", "../../images/head.png");
    }
    ...
    function lockPage() {
        layer.open({
            ...
            '<div class="admin-header-lock-img"><img src="images/head.png" class="userAvatar"/></div>' +
            '<div class="admin-header-lock-name" id="lockUserName">向阳</div>' +
            '<div class="input_btn">' +
